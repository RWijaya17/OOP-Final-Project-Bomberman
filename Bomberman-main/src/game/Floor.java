...
public class Floor {
    ...
    public static int pixelToSquare(int pixelCoord){
		// Converts a pixel coordinate to a corresponding square coordinate on the floor.
	...
	//  object at the specified row and column indices.
    ...
    public void moveEnemies() {
		// Moves the enemy characters on the floor.
		// Handles collision detection with blocks, bombs, and other enemies.
    ...
    public void playerInExplosion(){
		// Checks if the player or enemies are within the explosion coordinates.
		//Sets the game over flag if a collision occurs.
    ...
    public void characterInExplosion(){
		// Checks if both the player and enemies are within the explosion coordinates.
	playerInExplosion();
	enemyInExplosion();
    }
    ...
    public boolean collisionWithEnemies(){
		// checks if the player collides with any enemies.
    ...
    public boolean collisionWithBombs(AbstractCharacter abstractCharacter) {
		// checks if the player or enemies collide with any bombs.
    ...
    public boolean collisionWithBlock(AbstractCharacter abstractCharacter){
		// checks if the player or enemies collide with any blocks.
	for (int i = 0; i < height; i++) {
	    for (int j = 0; j < width; j++) {
    ...
    public void collisionWithPowerup() {
		// Checks if the player collides with any power-ups.
		//Adds the power-up to the player and removes it.
